...
const locationData = {
  ashanti: [
    { value: "kumasi", label: "Kumasi Metropolitan" },
    { value: "ejisu", label: "Ejisu Municipal" },
    { value: "juaben", label: "Juaben Municipal" },
    { value: "kwadaso", label: "Kwadaso Municipal" },
    { value: "nsuta", label: "Nsuta-Kwamang" },
    { value: "mampong", label: "Mampong Municipal" },
    { value: "bekwai", label: "Bekwai Municipal" },
    { value: "obeasi", label: "Obuasi Municipal" },
    { value: "offinso", label: "Offinso Municipal" },
    { value: "asiwa", label: "Asokwa" },
    { value: "tafo", label: "Tafo" },
    { value: "ahafo-ano", label: "Ahafo Ano North & South" },
    { value: "amanse", label: "Amansie Central" },
    { value: "adansi", label: "Adansi North & South" },
    { value: "atwima", label: "Atwima Kwanwoma" },
    { value: "kwabre", label: "Kwabre East" },
    { value: "sekyere", label: "Sekyere Central" },
    { value: "ejura", label: "Ejura-Sekyedumase" },
  ],
  accra: [
    { value: "accra-metro", label: "Accra Metropolitan" },
    { value: "tema-metro", label: "Tema Metropolitan" },
    { value: "ga-central", label: "Ga Central Municipal" },
    { value: "ga-east", label: "Ga East Municipal" },
    { value: "ga-west", label: "Ga West Municipal" },
    { value: "ga-north", label: "Ga North Municipal" },
    { value: "ga-south", label: "Ga South Municipal" },
    { value: "ledzokuku", label: "Ledzokuku Municipal" },
    { value: "krowor", label: "Krowor Municipal" },
    { value: "la-dade", label: "La Dade Kotopon Municipal" },
    { value: "la-nkwanta", label: "La Nkwanta Municipal" },
    { value: "ablekuma", label: "Ablekuma Central" },
    { value: "ashaiman", label: "Ashaiman Municipal" },
    { value: "ada", label: "Ada East & West" },
    { value: "shai-osudoku", label: "Shai Osudoku" },
    { value: "ningo-prampram", label: "Ningo Prampram" },
  ],
  bono: [
